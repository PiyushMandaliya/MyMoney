...
open class DatePickerDialog: UIView {
    ...
    @objc public init(
        ...
        self.textColor = textColor ?? Color.text
        self.buttonColor = buttonColor ?? Color.accent
        self.font = font
    ...
    private func createContainerView() -> UIView {
        ...
        gradient.colors = Color.gradientBackground
        ...
        lineView.backgroundColor = Color.separator
